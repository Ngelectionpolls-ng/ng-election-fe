...
export default function LGAResults({lgaValue, wards, wardResults}){

    return (
        <>
            <div className="w-full p-4 text-xs">
                Result from {wards?.length} Wards in <span className="text-green-800 font-bold">{titleCase(lgaValue)} LGA</span>
            </div>
