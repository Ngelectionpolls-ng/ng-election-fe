...
export default function RecentEyewitnessActivities(){
    ...
    return (
        <div className="w-full flex flex-col space-y-4">
            <div className="w-ful flex justify-between items-center">
                <h6 className="text-xs font-semibold">Recent updates of eyewitness reports from all polling units</h6>
            ...
            <div className="w-full overflow-x-scroll flex justify-between flex-wrap md:flex-nowrap space-y-4 md:space-y-0 md:space-x-6">
                {
                    activities.map((activity, index) => {
                        return (
                            ...
                            <div className="py-2 my-1 flex flex-col space-y-2 w-full md:w-[250px] p-4 rounded-xl shadow-xl bg-white hover:bg-slate-50 cursor-pointer" key={`activity-${index}`}>
