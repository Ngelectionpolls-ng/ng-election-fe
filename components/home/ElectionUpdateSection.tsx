              ...
              return (
                <div className="flex items-center gap-6" key={content.id}>
                  ...
                  <div className="flex flex-col">
                    <p><span className="font-bold">{content.heading}: </span> <span className="font-bold text-red-500">Nov 8 - 11:40PM ET </span></p>
                    <p>{content.content}</p>
                    <Link
                      href={"#"}
                      className="text-[#6366F1] mt-2 hover:underline"
                    >
                      Read more
                    </Link>
                  </div>
