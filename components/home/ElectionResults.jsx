...
export default function ElectionResults({x=50, y=100, visible=false}) {
  return (
    <div className={`w-[343px] h-[260px] mx-auto p-3 bg-gray-800 text-white rounded-lg shadow-lg space-y-3 absolute z-10 left-[${x}px]  top-[${y}px] ${visible ? 'block' : 'hidden'}`}>
      {/* Title */}
      <div>
        <h2 className="text-sm font-semibold">Edo State Election</h2>
