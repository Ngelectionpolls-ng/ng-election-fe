...
function ResetPassword() {
  ...
  const onSubmit = async (data: FieldValues) => {
    ...
    setIsLoading(true);
    const response = await postData(RESET_PASSWORD, payload);
  ...
  return (
    <AuthLayout
      ...
      bgImg="loginpasswordcreate.png"
    >
      <form
        className="w-full border-red-600 min-w-[550px]"
          ...
          <Controller
            ...
            rules={{
              ...
              validate: {
                ...
                hasNumber: (value) =>
                  /[0-9]/.test(value) ||
                  "Password must contain at least one number", // Added number validation
