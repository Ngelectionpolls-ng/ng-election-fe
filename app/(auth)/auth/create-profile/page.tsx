...
import {
  ...
  sexOption,
  stateOption,
} from "@/utils/data/createProfileData";
import { CreateProfilePayload } from "@/services/api/create-profile";
import { CREATE_PROFILE } from "@/services/endpoints";
...
function CreateProfile() {
  ...
  const headerTitle = "Update your profile";
  const headerSubTitle = "";

  const onSubmit = async (data: FieldValues) => {
    const payload: CreateProfilePayload = {
      accountType: "pollingUnitAgent",
    ...
    const response = await postData(CREATE_PROFILE, payload);
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-6 mt-6">
          ...
          <FormControl
            ...
            error={
              typeof errors.LGAId?.message === "string"
          ...
          <FormControl
            ...
            error={
              typeof errors.wardId?.message === "string"
          ...
          <FormControl
            ...
            error={
              typeof errors.pollingUnitId?.message === "string"
                ? errors.pollingUnitId.message
                : undefined
            }
          ...
          className="!w-full min-w-[551px]"
            ...
            error={
              typeof errors.politicalPartyId?.message === "string"
          ...
          className="w-full"
            ...
            error={
              typeof errors.ageRange?.message === "string"
